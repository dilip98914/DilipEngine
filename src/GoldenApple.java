...
public class GoldenApple extends CollectableEntity {

	public GoldenApple(float x, float y, float width, float height, float health,
			Handler handler) {
	...
	public void render() {//32 is dividing const
		Renderer.renderImage(handler.getAssets().getItems(), x-handler.getXOffset(),y-handler.getYOffset(), width, height,Creature.fillData(22f, 0f, 32f, 32f, 2f) ,1);
